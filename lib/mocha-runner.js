...
page.open(url, function (status) {
  ...
  page.injectJs('./shims/es5-shim.js');

  // add the node.js console
  page.injectJs('./shims/console.js');

  // add a shim for the node.js process.stdout.write
  page.injectJs('./shims/process.stdout.write.js');
  ...
  page.evaluate(function(options) {
    ...
    // todo: should it be done only client-sidely instead? maybe just override the reporter.
